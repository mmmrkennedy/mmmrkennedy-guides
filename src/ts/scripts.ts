 ...
 */
const HOVER_PREFETCH_ENABLED: boolean = false;
            ...
            { name: "Scroll Manager", fn: () => window.ScrollManager?.initHistoryManagement() },
            {
                ...
                fn: () => {
                    ...
                    if (!hash || hash.length <= 1) {
                        ...
                        if (window.ScrollManager?.restoreStampedScroll()) return;
                    ...
                    window.addEventListener(
                        ...
                        () => {
                            requestAnimationFrame(() =>
                                window.ScrollManager?.scrollToElement(id, "none"),
                            );
                        },
                        { once: true },
                    );
